                ...
                <div class="board__inner">
                    ...
                    <div class="board__table">
                        <table class="hover">
                            ...
                            <tbody>
                                ...
                                //1~20 : DESC LIMIT 0, 20 -> 0번부터 20개를 불러오는 것인데 LIMIT여서 반대로 / page = 1 ($numView * page) - $numView
                                //21~40 : DESC LIMIT 20, 20 -> 시작을 불러오는 것 / page = 2 ($numView * page) - $numView
                    ...
                    <div class="board__pages">
                        ...
                        <?php
                                ...
                                if($page != $endPage) {
                                    $nextPage = $page + 1;
                                    echo "<li><a href='board.php?page={$boardTotalPage}'>마지막</a></li>";
                                }
